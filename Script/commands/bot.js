...
if (
  ...
  if (
  (event.body.toLowerCase() == "ভালোবাসা দিবা") || 
  (event.body.toLowerCase() == "valobasha diba")
) {

  // Texts array (এক এক বার আলাদা দেখাবে)
  const texts = [
    "🥰 এই নাও রায়হান ও রুহির ভালোবাসার ভিডিও 🎬❤️",
    "💖 রায়হান ও রুহির স্পেশাল ভালোবাসার মুহূর্ত 🎬😍",
    "🔥 ঝাং, রায়হান ও রুহির মধুর মুহূর্ত ভিডিওতে 🎬💖",
    "😊 রায়হান ও রুহির লাভ স্টোরি দেখো এই ভিডিওতে 🎬💞",
    "🥳 প্রেমের ভিডিও সরাসরি রায়হান ও রুহি থেকে 🎬❤️"
  ];
